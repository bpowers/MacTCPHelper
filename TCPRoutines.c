...
OSErr LowTCPCreateStream(StreamPtr *streamPtr, Ptr connectionBuffer, unsigned long connBufferLen,
                         TCPNotifyProcPtr notifPtr, GiveTimePtr giveTimePtr, bool *cancel) {
  OSErr err;
  TCPiopb *pBlock;
...
OSErr LowFinishTCPWaitForConn(TCPiopb *pBlock, ip_addr *remoteHost, tcp_port *remotePort, ip_addr *localHost,
                              tcp_port *localPort) {
  OSErr err;
...
OSErr LowTCPWaitForConnection(StreamPtr streamPtr, SInt8 timeout, ip_addr *remoteHost, tcp_port *remotePort,
                              ip_addr *localHost, tcp_port *localPort, Boolean async, TCPiopb **returnBlock,
...
OSErr LowTCPOpenConnection(StreamPtr streamPtr, SInt8 timeout, ip_addr remoteHost, tcp_port remotePort,
                           ip_addr *localHost, tcp_port *localPort, GiveTimePtr giveTimePtr, bool *cancel) {
  OSErr err;
  TCPiopb *pBlock;
...
OSErr LowTCPSendData(StreamPtr streamPtr, SInt8 timeout, Boolean push, Boolean urgent, Ptr wdsPtr, Boolean async,
...
OSErr LowTCPNoCopyRcv(StreamPtr streamPtr, SInt8 timeout, Boolean *urgent, Boolean *mark, Ptr rdsPtr, short numEntry,
...
OSErr LowFinishTCPRecv(TCPiopb *pBlock, Boolean *urgent, Boolean *mark, unsigned short *rcvLen) {
  OSErr err;
...
OSErr LowTCPRecvData(StreamPtr streamPtr, SInt8 timeout, Boolean *urgent, Boolean *mark, Ptr rcvBuff,
                     unsigned short *rcvLen, Boolean async, TCPiopb **returnBlock, GiveTimePtr giveTimePtr,
                     bool *cancel) {
  OSErr err;
  TCPiopb *pBlock;
